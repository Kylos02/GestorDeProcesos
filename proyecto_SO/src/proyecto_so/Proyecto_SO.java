    ...
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= totProcesos; i++){ // El siguiente for ayudará a ingresar uno por uno los datos de todos los procesos totales que se declararon al principio
            ...
            do {
                ...
                memoProceso = scanner.nextInt();

                if (memoProceso  < 1) {
                    System.out.println("El valor ingresado debe ser mayor a cero. Por favor, inténtelo nuevamente.");
                }
            ...
            do {
                ...
                tiempoRafaga = scanner.nextInt();

                if (tiempoRafaga  < 1) {
                    System.out.println("El valor ingresado debe ser mayor a cero. Por favor, inténtelo nuevamente.");
                }
            } while (tiempoRafaga  < 1);
